...
class PPK1 extends CI_Controller {
	...
	public function simpandoc()
	{
		...
		$file1 = $namabaru.str_replace(' ', '_', $_FILES['file1']['name']);
		$file2 = $namabaru.str_replace(' ', '_', $_FILES['file2']['name']);
		$file3 = $namabaru.str_replace(' ', '_', $_FILES['file3']['name']);
		$file4 = $namabaru.str_replace(' ', '_', $_FILES['file4']['name']);
		$file5 = $namabaru.str_replace(' ', '_', $_FILES['file5']['name']);
		$file6 = $namabaru.str_replace(' ', '_', $_FILES['file6']['name']);
		$file7 = $namabaru.str_replace(' ', '_', $_FILES['file7']['name']);
		$file8 = $namabaru.str_replace(' ', '_', $_FILES['file8']['name']);
		$file9 = $namabaru.str_replace(' ', '_', $_FILES['file9']['name']);
		$file10 = $namabaru.str_replace(' ', '_', $_FILES['file10']['name']);
		$file11 = $namabaru.str_replace(' ', '_', $_FILES['file11']['name']);
		$file12 = $namabaru.str_replace(' ', '_', $_FILES['file12']['name']);
		$file13 = $namabaru.str_replace(' ', '_', $_FILES['file13']['name']);
		$file14 = $namabaru.str_replace(' ', '_', $_FILES['file14']['name']);
		$file15 = $namabaru.str_replace(' ', '_', $_FILES['file15']['name']);
		$file16 = $namabaru.str_replace(' ', '_', $_FILES['file16']['name']);
		$file17 = $namabaru.str_replace(' ', '_', $_FILES['file17']['name']);
		$file18 = $namabaru.str_replace(' ', '_', $_FILES['file18']['name']);
		$file19 = $namabaru.str_replace(' ', '_', $_FILES['file19']['name']);
		$file20 = $namabaru.str_replace(' ', '_', $_FILES['file20']['name']);
		$file21 = $namabaru.str_replace(' ', '_', $_FILES['file21']['name']);
		$file22 = $namabaru.str_replace(' ', '_', $_FILES['file22']['name']);
		$file23 = $namabaru.str_replace(' ', '_', $_FILES['file23']['name']);
		$file24 = $namabaru.str_replace(' ', '_', $_FILES['file24']['name']);
		$file25 = $namabaru.str_replace(' ', '_', $_FILES['file25']['name']);
		$file26 = $namabaru.str_replace(' ', '_', $_FILES['file26']['name']);
		$file27 = $namabaru.str_replace(' ', '_', $_FILES['file27']['name']);
		$file28 = $namabaru.str_replace(' ', '_', $_FILES['file28']['name']);
		$file29 = $namabaru.str_replace(' ', '_', $_FILES['file29']['name']);
		$file30 = $namabaru.str_replace(' ', '_', $_FILES['file30']['name']);
		$file31 = $namabaru.str_replace(' ', '_', $_FILES['file31']['name']);
		$file32 = $namabaru.str_replace(' ', '_', $_FILES['file32']['name']);
		$file33 = $namabaru.str_replace(' ', '_', $_FILES['file33']['name']);
		$file34 = $namabaru.str_replace(' ', '_', $_FILES['file34']['name']);
		$file35 = $namabaru.str_replace(' ', '_', $_FILES['file35']['name']);
		$file36 = $namabaru.str_replace(' ', '_', $_FILES['file36']['name']);
		$file37 = $namabaru.str_replace(' ', '_', $_FILES['file37']['name']);
		$file38 = $namabaru.str_replace(' ', '_', $_FILES['file38']['name']);
		$file39 = $namabaru.str_replace(' ', '_', $_FILES['file39']['name']);
		$file40 = $namabaru.str_replace(' ', '_', $_FILES['file40']['name']);
		$file41 = $namabaru.str_replace(' ', '_', $_FILES['file41']['name']);
		$file42 = $namabaru.str_replace(' ', '_', $_FILES['file42']['name']);
		$file43 = $namabaru.str_replace(' ', '_', $_FILES['file43']['name']);
		$file44 = $namabaru.str_replace(' ', '_', $_FILES['file44']['name']);
		$file45 = $namabaru.str_replace(' ', '_', $_FILES['file45']['name']);
		$file46 = $namabaru.str_replace(' ', '_', $_FILES['file46']['name']);
		$file47 = $namabaru.str_replace(' ', '_', $_FILES['file47']['name']);
		$file48 = $namabaru.str_replace(' ', '_', $_FILES['file48']['name']);
		$file49 = $namabaru.str_replace(' ', '_', $_FILES['file49']['name']);
		$file50 = $namabaru.str_replace(' ', '_', $_FILES['file50']['name']);
		$file51 = $namabaru.str_replace(' ', '_', $_FILES['file51']['name']);
		$file52 = $namabaru.str_replace(' ', '_', $_FILES['file52']['name']);
		$file53 = $namabaru.str_replace(' ', '_', $_FILES['file53']['name']);
		$file54 = $namabaru.str_replace(' ', '_', $_FILES['file54']['name']);
		$file55 = $namabaru.str_replace(' ', '_', $_FILES['file55']['name']);
		$file56 = $namabaru.str_replace(' ', '_', $_FILES['file56']['name']);
		$file57 = $namabaru.str_replace(' ', '_', $_FILES['file57']['name']);
		$file58 = $namabaru.str_replace(' ', '_', $_FILES['file58']['name']);
		$file59 = $namabaru.str_replace(' ', '_', $_FILES['file59']['name']);
		$file60 = $namabaru.str_replace(' ', '_', $_FILES['file60']['name']);
		$file61 = $namabaru.str_replace(' ', '_', $_FILES['file61']['name']);
		$file62 = $namabaru.str_replace(' ', '_', $_FILES['file62']['name']);
