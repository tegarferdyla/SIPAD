...
class Datapaket_model extends CI_Model {
	...
	public function daftarpaket ($id_ppk){
		$query = $this->db->query("SELECT b.id_paket, a.nama_tahun, b.nama_paket, b.jenis, b.input_by FROM tbl_tahun a , tbl_paket b WHERE b.id_tahun = a.id_tahun AND b.id_ppk = '$id_ppk' ORDER BY b.id_paket DESC");
	...
	public function viewjenispaket($id_tahun,$jenis)
	{
		$this->db->select('*');
		$this->db->from('tbl_paket');
		$this->db->where('id_tahun', $id_tahun);
     ...
     public function viewjenis($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
    		select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'surat_md' file, a.surat_md value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'surat_mh' file, a.surat_mh value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'surat_kl' file, a.surat_kl value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'kesepakatan_bersama' file, a.kesepakatan_bersama value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'perjanjian_kerjasama' file, a.perjanjian_kerjasama value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'sppbj' file, a.sppbj value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'spmk' file, a.spmk value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') g
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'naskah_kontrak' file, a.naskah_kontrak value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') h
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'rencana_mk' file, a.rencana_mk value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') i
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bcp' file, a.bcp value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') j
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'mc0_dd' file, a.mc0_dd value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') k
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'mc0_bal' file, a.mc0_bal value
			from tbl_doc1 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') l
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'mc0_jdst' file, a.mc0_jdst value
    ...
    public function viewjenis2($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
    		select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'laporan_harian1' file, a.laporan_harian1 value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'laporan_mingguan1' file, a.laporan_mingguan1 value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bulanan_kontraktor' file, a.bulanan_kontraktor value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'sertifikat_pembayaran' file, a.sertifikat_pembayaran value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'laporan_harian2' file, a.laporan_harian2 value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'laporan_mingguan2' file, a.laporan_mingguan2 value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bulanan_konsultan' file, a.bulanan_konsultan value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') g
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'berita_apm' file, a.berita_apm value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') h
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'berita_ascm' file, a.berita_ascm value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') i
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'provisional_sp' file, a.provisional_sp value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') j
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'provisional_bafv' file, a.provisional_bafv value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') k
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'provisional_basv' file, a.provisional_basv value
			from tbl_doc2 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') l
			union
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'provisional_bastp' file, a.provisional_bastp value
    ...
    public function viewjenis3($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
    		select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'final_sp' file, a.final_sp value
			from tbl_doc3 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'final_bafv' file, a.final_bafv value
			from tbl_doc3 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'final_basv' file, a.final_basv value
			from tbl_doc3 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'final_bastp' file, a.final_bastp value
			from tbl_doc3 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'final_dokumentasi' file, a.final_dokumentasi value
    ...
    public function viewjenis4($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
    		select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_bal' file, a.addii_bal value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_boq' file, a.addii_boq value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_jdst' file, a.addii_jdst value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_slp' file, a.addii_slp value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_kurva' file, a.addii_kurva value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_shop' file, a.addii_shop value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_bakln' file, a.addii_bakln value
			from tbl_addendumii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') g
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addii_naii' file, a.addii_naii value
    ...
    public function viewjenis5($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_bal' file, a.addiii_bal value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_boq' file, a.addiii_boq value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_jdst' file, a.addiii_jdst value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_slp' file, a.addiii_slp value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_kurva' file, a.addiii_kurva value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_shop' file, a.addiii_shop value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_bakln' file, a.addiii_bakln value
			from tbl_addendumiii a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') g
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiii_naiii' file, a.addii_naiii value
    ...
    public function viewjenis6($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_bal' file, a.addiv_bal value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_boq' file, a.addiv_boq value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_jdst' file, a.addiv_jdst value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_slp' file, a.addiv_slp value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_kurva' file, a.addiv_kurva value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_shop' file, a.addiv_shop value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_bakn' file, a.addiv_bakn value
			from tbl_addendumiv a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') g
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'addiv_naiv' file, a.addiv_naiv value
    ...
    public function viewjenis7($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_boq' file, a.pasca_boq value
			from tbl_pascamc0 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_jdst' file, a.pasca_jdst value
			from tbl_pascamc0 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_slp' file, a.pasca_slp value
			from tbl_pascamc0 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_kurva' file, a.pasca_kurva value
			from tbl_pascamc0 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_shop' file, a.pasca_shop value
			from tbl_pascamc0 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_bakn' file, a.pasca_bakn value
			from tbl_pascamc0 a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'pasca_nai' file, a.pasca_nai value
    ...
    public function viewjenis8($id_tahun,$jenis)
    {
    	$query = $this->db->query("SELECT id_paket, sum(hasil) hasil from (
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bmn_surat_alih' file, a.bmn_surat_alih value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') a
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bmn_rekomendasi' file, a.bmn_rekomendasi value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') b
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bmn_surat_hibah' file, a.bmn_surat_hibah value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') c
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_permohonan' file, a.keuangan_permohonan value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') d
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_kuitansi' file, a.keuangan_kuitansi value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') e
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_kartu' file, a.keuangan_kartu value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') f
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_faktur' file, a.keuangan_faktur value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') g
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_pph' file, a.keuangan_pph value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') h
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_spp' file, a.keuangan_spp value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') i
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_spm' file, a.keuangan_spm value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') j
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'keuangan_sp2d' file, a.keuangan_sp2d value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') k
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bendahara_lpj' file, a.bendahara_lpj value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') l
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bendahara_bapkdr' file, a.bendahara_bapkdr value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') m
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bendahara_rekening' file, a.bendahara_rekening value
			from tbl_pendukung a, tbl_paket b where a.id_paket = b.id_paket AND b.id_tahun = '$id_tahun' AND b.jenis= '$jenis') n
			UNION
			select * , if(value = '',0,1) as hasil from(
			select a.id_paket, 'bendahara_bapk' file, a.bendahara_bapk value
