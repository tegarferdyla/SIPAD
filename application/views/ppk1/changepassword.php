                    ...
                    <div class="col-md-12 widget-holder">
                        <div class="widget-bg">
                            <div class="widget-body clearfix">
                                <h5 class="box-title mr-b-0">Change Password</h5>
                                <form>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l0">Old Password</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="l0" placeholder="Old Password" type="password" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="l0">New Password</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="l0" placeholder="New Password" type="password" required>
                                        </div>
                                    </div>
