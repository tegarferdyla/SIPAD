    <div class="content-wrapper">
        ...
        <aside class="site-sidebar scrollbar-enabled" data-suppress-scroll-x="true">
            <!-- Sidebar Menu -->
             <div class="side-content mr-t-30 mr-lr-15"><a class="btn btn-block btn-info ripple fw-600" href="">Unit Kerja <br><?php echo ucwords($this->session->userdata('bagian')); ?></a>
            </div>
