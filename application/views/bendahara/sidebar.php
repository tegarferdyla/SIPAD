                ...
                <ul class="nav in side-menu">
                    <li class="menu-item-has-children"><a href="javascript:void(0);"><i class="list-icon feather feather-briefcase"></i> <span class="hide-menu">Divisi</span></a>
                        ...
                        <?php foreach ($get_ppk  as $u) { ?>
                            <li><a href="<?php echo base_url()."Bendahara/tahun/".$u['id_ppk']; ?>"=><?php echo $u['nama']; ?></a>
                        <?php } ?>    
                        </ul>
                    </li>
                     <li class="current-page "><a href="<?php echo site_url('Bendahara/editprofile') ?>"><i class="list-icon feather feather-user"></i><span class="hide-menu">User Profile</span></a>
                    </li>
                </ul>
                <!-- /.side-menu -->
            </nav>
